...
async function main() {
    ...
    const employeePassword = await bcryptjs_1.default.hash('employee123', 12);
    ...
    const sampleExpenses = [
        ...
        },
        {
            ...
            exchangeRate: 1.0,
            category: client_1.ExpenseCategory.OFFICE,
